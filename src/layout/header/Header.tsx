...
const Header = () => {
  ...
  return (
    <header  >
      <nav className="bg-lila border-gray-200 px-20 max-screen-xl flex items-center justify-between mx-auto p-4">
        <a href="https://flowbite.com/" className="flex items-center space-x-3 rtl:space-x-reverse">
          <img src="/Logo.svg" alt="Flowbite Logo" className="h-10 w-auto" />
          <span className="text-2xl font-semibold whitespace-nowrap dark:text-white">PulLab</span>
        </a>
        ...
        <div className="flex gap-3">
          ...
          <ul className="flex gap-3" >
            <li className="relative" >
              <a onClick={()=>toggleDropdown("enfermedad")}  className="bg-white p-2 rounded-3xl font-bold flex text-gray-800" >
                ENFERMEDAD
              ...
              {openDropdown === "enfermedad" && (
                <div className="absolute left-0 mt-2 w-100 rounded-md             shadow-lg bg-white ring-1 ring-black ring-opacity-5 z-10">
          ...
          <div className="w-10 h-10 bg-white rounded-full flex justify-center items-center">
            <svg className="w-7 h-7 text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
