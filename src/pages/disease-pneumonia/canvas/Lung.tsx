...
const Lung = () => {
    ...
    const position: Vector3 = new Vector3(0,-2.9,0)
    ...
    return (
        ...
        <Suspense fallback={<h5>Cargando...</h5>}>
            <Canvas camera={{ position: [2, 0, 6] }}  style={{ height: "80vh", width: "100%" }} shadows={true}>
                ...
                <Html center  position={[0,4,0]} >
                    <Button onClick={handleClick} label="Interactuar" color={!isActiveAnimation ? 'amber' : 'green' } />
                </Html>
