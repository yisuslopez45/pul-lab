...
import PreventionModel from '../models-3d/PreventionModel';
...
const SceneContent = ({ rotating, setRotating }: SceneContentProps) => {
  ...
  return (
    <>
      ...
      <AlertText3D
        text={`dieta rica en frutas y verduras`}
        height={0.1}
        size={0.7}
        position={[1, -2, 5]}
      />
...
export default DiseasePreventionModel;
