...
import PodiumCanva from "./canva/PodiumCanva";
...
const Resultado = () => {
  ...
  return (
    <div className=" mt-10 mx-auto m-6 p-6 bg-indigo-900/80 rounded-lg border-4 border-indigo-700">
      <div className="text-center">

      </div>
      <div style={{display: "flex", height: "70vh", width: "100%"}}>
        <div style={{ width: "50%"}} className="mt-6  text-center p-4 bg-indigo-950 rounded border-2 border-indigo-800">
          {loading && (
            <Spinner />
          )}
