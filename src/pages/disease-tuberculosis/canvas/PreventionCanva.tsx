...
import { PreventionTuberculosisModel } from "../models-3d/PreventionTuberculosisModel";
            ...
            <Suspense fallback={<Spinner />}>
                <KeyboardControls map={map}>
                    <Canvas camera={{ position: [2, 10, 50] }} style={{ height: "80vh", width: "100%" }} shadows={true}>
                        ...
                        <PreventionTuberculosisModel scale={30} position={[0, 0, 0.8]} castShadow />
                        <Html center>
                        ...
                        <AlertText3D
                            text={`Usa cubrebocas para la prevencion `}
                            height={0.1}
                            size={3}
                            position={[-10, -5, 30]}
                        />
